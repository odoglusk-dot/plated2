    ...
    for (const user of users) {
      ...
      const emailRes = await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          ...
          text: "Just a friendly nudge — you haven't logged any food in Krafft today. A quick log now keeps your streak alive.\n\nTurn this off anytime: Krafft -> Profile -> Email Reminders.",
        }),
      });
      if (emailRes.ok) {
        sent++;
